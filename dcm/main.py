...
class DcmController:
    ...
    def moveToPage(self,pageName):
        ...
        if pageName in self.activePages:
            ...
            #otherwise creates an instance of page and raises it to the top
    ...
    #attempts to login and returns True if sucessful
    ...
    #registor page logic, returns True is sucessful
    def toRegPage(self):
    ...
    #Registors a new user and retuns 1 if it succeds
